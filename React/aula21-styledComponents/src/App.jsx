...
const Preco = styled.p`
  background: ${({cor}) => cor};  //Por ser uma expressão JS, podemos utilizar comandos javascript para
                                  //definirmos a cor como quisermos, por exemplo cores aleatórias
                                  //utilizando Math.random()
                                  //EX: background: hsl(${Math.random() * 360}, 100%, 50%);
  color: white;
`
